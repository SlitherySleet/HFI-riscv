...
Moreover, verfiying performance is not possible as QEMU does not have proper features for verifying cycles.
...
In such an implementation, in addition to functional correctness as in QEMU, resistance to spectre attacks can be evaluated. 
...
As an implementation in a cycle accurate simulator is comparatively much slower in modification of the libraries and execution as compared to QEMU, as a feasibility metric for correctness, an implementation in QEMU was ideal with respect to our circumstances.
