...
A more comprehensive implementation for security and performance in addition to ISA semantics can be considered in gem5 as done in the original HFI paper \cite{HFI}. 
