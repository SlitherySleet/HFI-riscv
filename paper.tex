...
To implement our instruction we have opted to use the CUSTOM0 opcode which is $0001011$.
...
For these new load instructions, we used opcode $0001011$. For the new store instructions, we used the opcode $1011011$. You can find the funct3 values we used to differentiate between them in Table~\ref{tab:hfi_instructions}.
